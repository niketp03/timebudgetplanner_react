...
export default class HSCT extends React.Component {
    ...
    handleValChangeHSCT = (name, e) => {
        ...
        this.setState({hourValues: currentHours})
        this.props.updateChart(currentHours, null, null, this.state.itemValues)
      }
        ...
        return (
            <div class="container">
                <div class="content-section-heading text-center">
                    ...
                    <h4>Please leave it as "Select a Class" if you do not have a class in that section. All hours are listed per 7-day week.</h4>
